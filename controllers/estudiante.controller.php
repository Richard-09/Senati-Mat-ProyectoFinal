  ...
  $data = $estudiante->listarEstudiante();
    if ($data){
      ...
      foreach($data as $registro){
        $datosEstudiante = $registro['estudiante'];
        echo "
          <tr>
            <td>{$numeroFila}</td>,
        ...
        if ($registro['fotografia']== ''){
          ...
          echo "<a href='../views/img/fotografias/{$registro['fotografia']}' data-lightbox='{$registro['idestudiante']}' data-title='{$datosEstudiante}' class='btn btn-sm btn-outline-warning'title='ver'><i class='bi bi-eye-fill'></i></a>";
        }
